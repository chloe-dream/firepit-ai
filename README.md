...
> **Status: V1 feature-complete + V0.5.x platform layer in daily-driver use.** Latest release: `v0.5.13` — see [`CHANGELOG.md`](./CHANGELOG.md). The v0.5 line added per-project `.firepit/` config, the Firepit MCP server, a hidden meta-project, cross-Claude inbox, lazy tab restore, keyboard shortcuts, window placement persistence, and scheduled jobs.
